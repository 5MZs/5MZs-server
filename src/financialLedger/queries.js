...
const postFinancialLedgerMonth = "SELECT id, user_id, place_name, price, date, latitude, hardness FROM public.financial_ledger WHERE TO_CHAR(date, 'MM') = $1 AND user_id = $2;"
